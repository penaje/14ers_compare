...
def import_images_all_trails(peak_name):
    """Creates a list of image urls from all trails page"""

    base_url = 'https://www.alltrails.com/trail/us/'

    image_list = []

    input_json = {'COMMAND': 'SCRAPE', 'TARGET': base_url + info.all_trails.get(peak_name)}  # Request format

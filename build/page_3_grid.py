...
title_3_label.grid(row=1, column=7, sticky=NW, padx=10, pady=5, ipadx=2, ipady=2)
...
img_2_holder.grid(row=1, rowspan=2, column=6, columnspan=1, padx=10, pady=5, ipadx=2, ipady=2)
...
img_3_holder.grid(row=1, rowspan=2, column=10, columnspan=1, padx=10, pady=5, ipadx=2, ipady=2)
...
info_box_2.grid(row=2, column=4, columnspan=1, padx=10, pady=5, ipadx=2, ipady=2)

info_box_3 = Frame(second_frame, padx=5, pady=5, bd=2, bg="#D3D3D3")
info_box_3.grid(row=2, column=7, columnspan=2, padx=10, pady=5, ipadx=2, ipady=2)
...
prominence_3 = Label(info_box_3, text="Prominence: " + info.peaks_prominence.get(info.selected_peaks[2]), bg="#D3D3D3")
...
climbing_info_frame_3.grid(row=3, column=10, padx=10, pady=5, ipadx=2, ipady=2)
...
image_link_3.grid(row=3, rowspan=1, column=7, columnspan=1, padx=15, pady=10, ipadx=5, ipady=5)
image_link_3.bind("<Button-1>", lambda e: callback("https://www.alltrails.com/trail/us/colorado/mount-bierstadt-trail"))
